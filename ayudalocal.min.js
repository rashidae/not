...
// Check if the current URL is '/electricidad'
if (currentURL === '/electricidad') {
    // Select the elements and modify the styles only on this page
    const navbarElement = document.querySelector('.super-navbar');
    if(navbarElement) navbarElement.style.display = 'none';

    const headerElement = document.querySelector('.notion-header');
